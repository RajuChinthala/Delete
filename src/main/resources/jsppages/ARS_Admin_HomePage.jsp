...
<form>
 ...
 <table border="1" cellspacing="10" align="center">
    ...
    <tr>
         <td><a href="${pageContext.request.contextPath}/airline/showAddOrUpdate.obj">Manage Flight Information</a></td>
		 <td><a href="${pageContext.request.contextPath}/airline/getFlightInformationPageAdmin.obj" >View List of flights </a></td>
	</tr>
	
	<tr>
     	<td><a href="${pageContext.request.contextPath}/airline/showAdminBookingDetailsPage.obj">View Bookings</a></td>
     	<td><a href="${pageContext.request.contextPath}/airline/showAdminPassengerListPage.obj"">View Passenger List</a></td>
    </tr>
