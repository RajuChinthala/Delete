...
<script src="${pageContext.request.contextPath}/js/iGateCommon.js" type="text/javascript"></script>
...
<%
/************************************************************************************
 * File          :  ARS_View_FlightInfo_Admin.jsp
 * Description   : 	This page has list of source,destination  and date.Admin has to select these and click on button to see
                    list of flight details
 * Functionality :	Based on source,destination and date  selected flight details are displayed in ARS_View_ShowFlights_Admin.jsp
 * Author		 :	jc815790				      
...
<c:url var="myAction" value="showFlightInformationAdmin.obj" />
